...
rem Close this window to stop ShopBooks. Your books live in %USERPROFILE%\ShopBooks
rem (books.db + docs\ + backups\) - a fixed folder outside %AppData% so it reads the same no
rem matter how the app is launched (db.py picks this automatically; no override needed here).
cd /d "%~dp0"
